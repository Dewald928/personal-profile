...
import logoYknot from '@/images/logos/yknot.png'
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'MuST Research Group',
      title: 'Researcher',
      logo: logoMust,
      start: '2019',
      end: '2020',
      url: 'https://www.linkedin.com/in/must-deep-learning-741659268/?originalSubdomain=za',
    },
  ]
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <a href="cv.pdf" download="cv.pdf" className="mt-6 block">
      ...
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[image1, image2, image3, image4, image5].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
              'relative aspect-[9/10] w-44 flex-none transform overflow-hidden rounded-xl bg-zinc-100 transition-transform duration-200 hover:scale-105 dark:bg-zinc-800 sm:w-72 sm:rounded-2xl',
